                    ...
                    <div class="row">
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <% } else {%>
                                <span class="form-control" disabled ><%=cat.getIdCategoria()%></span>
                                <% }%>
                                <input class="form-control"  type="hidden" name="id" value="<%=cat.getIdCategoria()%>"/>
                        ...
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nome" value="<%=editando != null ? cat.getNomeCategoria() : ""%>"/>
                            </div>
                        </div>
                    </div>
