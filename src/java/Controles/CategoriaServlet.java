    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (!request.getParameter("id").equals("null")) {
                ...
                Categoria categoria = daoCategoria.listById(id).get(0);
                categoria.setNomeCategoria(nome);//novo nome
            ...
            response.sendRedirect(request.getContextPath() + "/paginas/categoriaLista.jsp");
        }
    }
